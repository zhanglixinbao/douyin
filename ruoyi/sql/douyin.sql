...
CREATE TABLE `customer` (
  ...
  `trade` varchar(255) DEFAULT NULL COMMENT '所属行业',
  `business` varchar(255) DEFAULT NULL COMMENT '是否营业执照',
  `province` varchar(255) DEFAULT NULL COMMENT '所在省',
  `city` varchar(255) DEFAULT NULL COMMENT '所在市',
  `products` varchar(255) DEFAULT NULL COMMENT '咨询产品',
  `ps` varchar(255) DEFAULT NULL COMMENT '需求',
  PRIMARY KEY (`userid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='客户';

-- ----------------------------
-- Records of customer
-- ----------------------------
BEGIN;
INSERT INTO `customer` VALUES (1, '1', '13333333333', '1', '1', '120000', '120200', '企业网站建设', '111');
COMMIT;
